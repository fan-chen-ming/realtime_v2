...
import com.cm.constant.JdbcUtil;
import com.cm.stream.domain.DimBaseCategory;
import com.cm.stream.domain.DimCategoryCompare;
...
/**
 * @Package com.cm.dwd.DwdScoreApp
 * @Author chen.ming
...
public class DwdScoreApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSourceLog = FlinkSourceUtil.getKafkaSource("chenming_page_Log", "page_Log");
        ...
        SingleOutputStreamOperator<JSONObject> operator = streamOperatorlog.map(new RichMapFunction<JSONObject, JSONObject>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                String sql1 = "select b3.id,                  \n" +
                        ...
                        "     b2.name as b2name,              \n" +
                        "     b1.name as b1name               \n" +
                        "     from dev_realttime_gmall_chenming.base_category3 as b3  \n" +
                        "     join dev_realttime_gmall_chenming.base_category2 as b2  \n" +
                        "     on b3.category2_id = b2.id             \n" +
                        "     join dev_realttime_gmall_chenming.base_category1 as b1  \n" +
                        "     on b2.category1_id = b1.id";
                dim_base_categories = JdbcUtil.queryList(connection, sql1, DimBaseCategory.class, false);

                String sql2 = "select id, category_name, search_category from dev_realttime_gmall_chenming.category_compare_dic;";
