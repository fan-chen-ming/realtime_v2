...
public class DwdLogApp {
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSourceLog = FlinkSourceUtil.getKafkaSource("chenming_log", "dwd_app");
...
//        operator.print();
        ...
        operator.sinkTo(FlinkSinkUtil.getFlinkSinkUtil("chenming_page_Log"));
