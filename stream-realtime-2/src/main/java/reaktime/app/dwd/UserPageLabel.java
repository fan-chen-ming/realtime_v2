...
import reaktime.app.utils.JdbcUtils;
import reaktime.bean.DimBaseCategory;
import reaktime.func.AggregateUserDataProcessFunction;
import reaktime.func.MapDeviceAndSearchMarkModelFunc;
import reaktime.func.MapPageInfoFacility;
import reaktime.func.ProcessFilterRepeatTsData;
...
public class UserPageLabel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        deviceAndSearchMarkModelPageLogsDsSinkToKafka.sinkTo(FlinkSinkUtil.getFlinkSinkUtil("dwd_page_info_base_chenming"));
