...
public class DwdBaseLog {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KafkaSource<String> kafkaSource = FlinkSourceUtil.getKafkaSource("chenming_log", "dwd_log");
...
//        jsonObjDS.print();
        ...
        dirtyDS.sinkTo(FlinkSinkUtil.getFlinkSinkUtil("dirty_data"));
...
//        fixedDS.print();
        ...
        streamMap
                .get(PAGE)
                .sinkTo(FlinkSinkUtil.getFlinkSinkUtil(Constant.TOPIC_DWD_TRAFFIC_PAGE));
        streamMap
                .get(ERR)
                .sinkTo(FlinkSinkUtil.getFlinkSinkUtil(Constant.TOPIC_DWD_TRAFFIC_ERR));
        streamMap
                .get(START)
                .sinkTo(FlinkSinkUtil.getFlinkSinkUtil(Constant.TOPIC_DWD_TRAFFIC_START));
        streamMap
                .get(DISPLAY)
                .sinkTo(FlinkSinkUtil.getFlinkSinkUtil(Constant.TOPIC_DWD_TRAFFIC_DISPLAY));
        streamMap
                .get(ACTION)
                .sinkTo(FlinkSinkUtil.getFlinkSinkUtil(Constant.TOPIC_DWD_TRAFFIC_ACTION));
