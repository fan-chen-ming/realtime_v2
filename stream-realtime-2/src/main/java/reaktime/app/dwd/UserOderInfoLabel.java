...
import reaktime.func.MapCategoryAndTrademarkAndPriceAndTimeFunc;
...
/**
 * @Package app.dwd.UserOderInfoLabel
 * @Author chen.ming
...
public class UserOderInfoLabel {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<String> kafkaSourceDs = env.fromSource(
                FlinkSourceUtil.getKafkaSource("chenming_db", "kafka_source_order_info"),
